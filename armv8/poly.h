...
void poly_tobytes_arm(uint8_t r[KYBER_POLYBYTES], const poly *a);
#define poly_frombytes KYBER_NAMESPACE(_poly_frombytes)
void poly_frombytes(poly *r, const uint8_t a[KYBER_POLYBYTES]);
void poly_frombytes_arm(poly *r, const uint8_t a[KYBER_POLYBYTES]);
...
/*  NEW FUNCTIONS */
#define poly_sub_reduce KYBER_NAMESPACE(_poly_sub_reduce)
void poly_sub_reduce(poly *r, const poly *a, const poly *b);

#define poly_add_reduce KYBER_NAMESPACE(_poly_add_reduce)
void poly_add_reduce(poly *r, const poly *a, const poly *b);

#define poly_add_add_reduce KYBER_NAMESPACE(_poly_add_add_reduce)
